defmodule TakeItForASpin.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule TakeItForASpin.MyChannel do
        use TakeItForASpin.Web, :channel
  ...
  """
  use Phoenix.Presence, otp_app: :take_it_for_a_spin,
                        pubsub_server: TakeItForASpin.PubSub
end
